...
constexpr float LINE_POS_CALC_INTENSITY_GROUP_RADIUS          = 0.8f;
constexpr uint8_t LINE_POS_CALC_GROUP_RADIUS                  = 2.5f;
constexpr float LINE_POS_CALC_MAX_VALID_AVERAGE               = 0.5f;
constexpr float LINE_POS_CALC_MAX_PROBABILITY_GROUP_INTENSITY = 0.8f;
constexpr micro::millimeter_t MAX_LINE_JUMP                   = micro::millimeter_t(8);
constexpr micro::millimeter_t MIN_LINE_DIST                   = micro::millimeter_t(15);
constexpr int8_t LINE_FILTER_HYSTERESIS                       = 5;
constexpr uint8_t LINE_VELO_FILTER_SIZE                       = 4;
constexpr uint8_t LINE_FILTER_WINDOW_SIZE                     = 1;
