...
TEST(LinePatternCalculator, JUNCTION_2_NEGATIVE_LEFT_TO_JUNCTION_2_POSITIVE_RIGHT_WITH_CHECKPOINT_noisy) {
    const LineDetections lineDetections = {
        { { millimeter_t(0) } },
        { { millimeter_t(0) } },
        { { millimeter_t(0) } },
...
TEST(LinePatternCalculator, JUNCTION_1_NEGATIVE_CENTER_TO_JUNCTION_2_POSITIVE_RIGHT_WITH_CHECKPOINT) {
    const LineDetections lineDetections = {
        { { millimeter_t(0) } },
        { { millimeter_t(0) } },
        { { millimeter_t(0) } },
...
TEST(LinePatternCalculator, JUNCTION_2_NEGATIVE_RIGHT_TO_JUNCTION_1_POSITIVE_CENTER_WITH_CHECKPOINT) {
    const LineDetections lineDetections = {
        { { millimeter_t(0) } },
        { { millimeter_t(0) } },
        { { millimeter_t(0) } },
...
TEST(LinePatternCalculator, JUNCTION_2_NEGATIVE_RIGHT_TO_JUNCTION_1_POSITIVE_CENTER_WITH_CHECKPOINT_noisy) {
    const LineDetections lineDetections = {
        { { millimeter_t(0) } },
        { { millimeter_t(0) } },
        { { millimeter_t(0) } },
...
TEST(LinePatternCalculator, JUNCTION_3_NEGATIVE_LEFT_TO_JUNCTION_3_POSITIVE_CENTER_WITH_CHECKPOINT) {
    const LineDetections lineDetections = {
        { { millimeter_t(0) } },
        { { millimeter_t(0) } },
        { { millimeter_t(0) } },
